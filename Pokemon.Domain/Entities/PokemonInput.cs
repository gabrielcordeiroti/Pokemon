...
namespace Pokemon.Domain.Entities
{
    ...
    //{
    //    public static Pokemon FromJson(string json) => JsonConvert.DeserializeObject<Pokemon>(json, QuickType.Converter.Settings);
    //}

    //public static class Serialize
    //{
    //    public static string ToJson(this Pokemon self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    //}
